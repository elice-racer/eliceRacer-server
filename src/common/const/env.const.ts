...
export const ENV_FIREBASE_TYPE_KEY = 'FIREBASE_TYPE';
export const ENV_FIREBASE_PROJECT_ID_KEY = 'FIREBASE_PROJECT_ID';
export const ENV_FIREBASE_PRIVATE_KEY = 'FIREBASE_PRIVATE_KEY';
export const ENV_FIREBASE_CLIENT_EMAIL_KEY = 'FIREBASE_CLIENT_EMAIL';
