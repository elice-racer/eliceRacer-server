...
export class AdminService {
  ...
  //     const processedStartDate = excelDateToJSDate(validData[0].startDate);
  //     const processedEndDate = excelDateToJSDate(validData[0].endDate);
